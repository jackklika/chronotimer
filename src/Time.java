...
public class Time {
	...
	private static long milliDate = date.getTimeInMillis(); // THIS MORNING
															// 12AM'S TIME

	// The difference between NOW and the desired time.
	// If up to date, it is simply 0.
	// If the time is set to 13:00:00.0 and it is in reality 13:00:00.0005 it
	// should be 5.
